<?php
$_['text_title']  = '<img src="https://www.payson.se/sites/all/files/images/external/payson150x55.png" style="width:150px;height:55px;clear:right" alt="Payson Direkt - Visa, MasterCard & Direct bank" title="Payson" />';
