...
$_['text_invoice_terms'] = '<div style="padding: 3px; margin-bottom: 5px;"><h2>Invoice terms <img src="catalog/view/theme/default/image/paysoninvoice.png" style="display: block; float: right;" /></h2>' . utf8_encode("If you choose to pay by Paysoninvoice there is an invoice fee of %sSEK inc VAT. Payment terms are 10 days and the invoice will be sent separately by email to the email address you specify. To pay by Paysoninvoice You must be 18 years old and be registered in Sweden as well as authorized in the credit assessment carried out at purchase.") . '</div>';
